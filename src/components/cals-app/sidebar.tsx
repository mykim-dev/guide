...
const navigationMenu = [
  ...
  },
  {
    id: 'screen',
    label: 'Screen',
    href: '/demo-cals-app/default/',
    icon: Columns3Cog,
    children: [
      { id: 'default', label: 'Default', href: '/demo-cals-app/default/', icon: Square },
      { id: 'horizontal', label: 'Horizontal', href: '/demo-cals-app/horizontal/', icon: Columns2 },
      { id: 'vertical', label: 'Vertical', href: '/demo-cals-app/vertical/', icon: Rows2 },
    ]
  },
  // {
  //   id: 'component',
  ...
  //   icon: Home,
  //   children: [
  //     { id: 'form', label: 'Form', href: '/demo-cals-app/', icon: Home },
  //     { id: 'list', label: 'List', href: '/demo-cals-app/', icon: Home }
  //   ]
  // }
];
