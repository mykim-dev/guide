...
import AIBot from "@/components/guide/aibot";
  ...
  return (
    <div className="flex flex-col gap-24">
      <div className="space-y-4">
        <h2 className="text-2xl font-bold">CALS AIBot</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 gap-5">
          {characters.map((character, index) => (
            <div key={character.variant} className="flex flex-col items-center space-y-4">
              <div className="w-full text-center p-4 bg-background rounded-lg border">
                <div 
