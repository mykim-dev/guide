          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            ...
            <Card>
              ...
              <CardFooter className="flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => downloadImage('/images/brand/logo-quintet.png', 'quintet-quintet-logo.png')}
                >
                  <DownloadIcon /> 다운로드
                </Button>
              </CardFooter>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            ...
            <Card>
              ...
              <CardFooter className="flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => downloadImage('/images/brand/symbol-quintet.png', 'quintet-symbol-logo.png')}
                >
                  <DownloadIcon /> 다운로드
                </Button>
              </CardFooter>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            <Card>
              ...
              <CardFooter className="flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => downloadImage('/images/brand/logo-mono.png', 'quintet-mono-logo.png')}
                >
                  <DownloadIcon /> 다운로드
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter className="flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => downloadImage('/images/brand/logo-mono2.png', 'quintet-mono-logo-white.png')}
                >
                  <DownloadIcon /> 다운로드
                </Button>
              </CardFooter>
